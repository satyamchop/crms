...
def index():
    ...
    Label(index_ui, text='CA Assignment', font='Helvetica 10', fg='#0D90CB', bg='#34383C').place(x=50, y=310)
    Label(index_ui, text='Submitted to Pooja Rana maam', font='Helvetica 10', fg='#0D90CB', bg='#34383C').place(x=50, y=330)
